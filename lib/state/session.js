...
function SessionStore(options) {
  ...
  this._isCustomStateKey = options.isCustomStateKey;
  this._skipStateValidation = options.skipStateValidation;
}
...
SessionStore.prototype.verify = function(req, handle, cb) {
  ...
  if (this._skipStateValidation) {
    return cb(null, { maxAge: null, nonce: null, issued: null }, null)
  }
